...
> Default voice profile for theological and spiritual books. Derived from the sermon-crafter theological framework and David's preaching style, upgraded to model the storytelling craft of bestselling Christian authors. Swap this file for a different voice profile to change the book's voice.
...
- Longer flowing sentences (20-30 words) for storytelling and narrative sections -- drawing the reader into a scene, painting a moment, setting up an illustration
- Vary rhythm deliberately: short punch -> longer narrative flow -> single-sentence dramatic beat -> medium explanation -> short punch. The reader should never be able to predict the next sentence's length.
...
- Average sentence length: 12-18 words overall, with storytelling sections ranging to 20-30 words and impact moments dropping to 3-8 word fragments.
...
- Reader engagement: "you", "imagine this", "picture yourself"
