...
- Do NOT use em dashes (— or spaced –) anywhere in author prose or headings. Use a spaced hyphen ( - ) or restructure the sentence. CRAFT-18 is a deterministic auto-revise gate.
- Do NOT use negation-pivot constructions more than once per chapter: "not just/merely/simply", "more than just", "not only...but also", "it's not about...it's about". One is acceptable; two or more triggers auto-revise. See `${CLAUDE_PLUGIN_ROOT}/references/bestseller-craft-rules.md` § CRAFT-18.
- Do NOT use AI-ism phrases from the banned list in `${CLAUDE_PLUGIN_ROOT}/references/bestseller-craft-rules.md` § CRAFT-18 (includes: delve, deep dive, tapestry, transformative power, furthermore, moreover, in conclusion, embark on, and 25 others). CRAFT-18 is a deterministic auto-revise gate.
- Do NOT use emoji in any author prose or headings.
