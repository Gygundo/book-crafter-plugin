...
- **Standalone:** User invokes `book-crafter:voice-builder` directly, pointing it at a directory of their writing. The profile is saved to `references/voice-profiles/` for future use.
...
> Generated by book-crafter:voice-builder on [YYYY-MM-DD].
